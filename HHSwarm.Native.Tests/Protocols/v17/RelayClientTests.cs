    ...
    public class RelayClientTests
    {
        ...
        public async Task RelayClient_NEWWDG_Test()
        {
            using (ShimsContext.Create())
            {
                ...
                MemoryStream mem = new MemoryStream(File.ReadAllBytes(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"Protocols\v17\Samples\MSG_REL_NEWWDG.bin")));
                MSG_REL msg_rel;
